public class Song
{
	...
	public boolean equals(Object obj)
	{
		...
		Song s = (Song) obj;
    if(s != null && title.equals(s.getTitle())&& album.equals(s.getAlbum())&&artist.equals(s.getArtist())&&songLength==(s.getLength())){
      return true;
    }else{
      return false;
    }
	...
	{
		return "" + getTitle() + "/" + getAlbum() + "/" + getArtist() + "(" + getLength() + ")";
	}
}
